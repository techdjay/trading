...
def analysis():
    ...
    for data, name, vote, pch, actual_pch ,ch in gen:
        ...
        plt.plot(pchs[-offset:], alpha=0.6, label="pch", c="olivedrab")
        plt.plot(x, pchs[-offset:], alpha=0.6, label="pchdot", marker="*")
