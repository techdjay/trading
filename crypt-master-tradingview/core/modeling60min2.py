...
def analysis():
    ...
    gen = dataset(select=["60","15"], crypts=crypts)
    global totalvotes
    temp = {}
    # WARNING = []
    offset = 0
    ...
    for data, name, vote, pch, actual_pch, ma, pc in gen:
        ...
        condiction["cross_pch"] = iscross01  # iscross01  # or iscross12 or iscross02
        ...
        for ee in indexofemail:
            ...
            plt.text(ee[0]-2, y=-pscale * 0.7,s=ee[1],alpha=0.8, fontsize=10,
                     color="grey",
                     style="italic", weight="light", rotation=45)
