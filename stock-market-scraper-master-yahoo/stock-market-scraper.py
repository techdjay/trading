    ...
    try:
        ...
        try:
            ...
            for i in parsed['chart']['result'][0]['timestamp']:
                Date.append(datetime.utcfromtimestamp(int(i)).strftime('%Y-%m-%d %H:%M:%S'))
...
def main():
	...
	for ticker in df['Ticker']:
	    query_urls.append("https://query1.finance.yahoo.com/v8/finance/chart/"+ticker+"?symbol="+ticker+"&period1=0&period2=9999999999&interval=5m&includePrePost=true&events=div%2Csplit")
