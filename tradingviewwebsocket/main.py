...
sendMessage(ws, "resolve_symbol", [chart_session,"symbol_1","={\"symbol\":\"NSE:SBIN\",\"adjustment\":\"splits\",\"session\":\"extended\"}"])
...
currency_list = ["NSE:BASML","NSE:BATAINDIA","NSE:BAYERCROP","NSE:BCLIND","NSE:UPL","NSE:UNIVPHOTO"]